...
#define LCF_INTVEC1_START 0x802FE000
#define LCF_INTVEC2_START 0x802FE000
#define LCF_INTVEC3_START 0x802FE000
#define LCF_INTVEC4_START 0x802FE000
#define LCF_INTVEC5_START 0x802FE000
...
/*OS USED*/ 
    section_layout :vtc:linear
    {
		group OS_CODE (ordered, align = 32, run_addr = mem:pfls0)
		{
			select ".text.Os_Code_Section";
			reserved "myreserved0" (size = 32);
		}
		group OS_KERNEL_NOINIT (ordered, align = 8, attributes=rw, run_addr = mem:lmuram)
		{
			select ".bss.OS_KERNEL_RAM_NOINIT_8BIT";
			select ".bss.OS_KERNEL_RAM_NOINIT_16BIT";
			select ".bss.OS_KERNEL_RAM_NOINIT_32BIT";
			select ".bss.OS_KERNEL_RAM_NOINIT_UNSPECIFIED";
			select ".bss.OS_KERNEL_RAM_NOINIT_MULTICORE_UNSPECIFIED";
			reserved "myreserved0" (size = 8, attributes = rw, fill = 0xaa);
		}
		group OS_KERNEL_INIT (ordered, align = 8, attributes=rw, run_addr = mem:lmuram)
		{
			select ".data.OS_KERNEL_RAM_INIT_UNSPECIFIED";
			select ".data.OS_KERNEL_RAM_INIT_MULTICORE_UNSPECIFIED";
			reserved "myreserved0" (size = 8, attributes = rw, fill = 0xaa);
		}
		group OS_CONST (ordered, align = 32, run_addr = mem:pfls0)
		{
			select ".rodata.DEFAULT_CONST_8BIT";
			select ".rodata.DEFAULT_CONST_16BIT";
			select ".rodata.DEFAULT_CONST_32BIT";
			select ".rodata.DEFAULT_CONST_UNSPECIFIED";
			reserved "myreserved0" (size = 32);
		} 
		group(ordered,run_addr = mem:dsram0,align = 8)
		{
			select ".bss.OS_STACK0";
		}
		group(ordered,run_addr = mem:dsram1,align = 8)
		{
			select ".bss.OS_STACK1";
		}
		group(ordered,run_addr = mem:dsram2,align = 8)
		{
			select ".bss.OS_STACK2";
		}
		group(ordered,run_addr = mem:dsram3,align = 8)
		{
			select ".bss.OS_STACK3";
		}
		group(ordered,run_addr = mem:dsram4,align = 8)
		{
			select ".bss.OS_STACK4";
		}
		group(ordered,run_addr = mem:dsram5,align = 8)
		{
			select ".bss.OS_STACK5";
		}
/*OS SC3 USED*/ 
		group MemMapAddressingModeSet_Core0_Application0_CODE (ordered, align = 8, attributes=rw, run_addr = mem:dsram0)
		{
			select "*.MemMapAddressingModeSet_Core0_Application0";
			reserved "myreserved0" (size = 8, attributes = rw, fill = 0xaa);
		}
...
/*USS Driver API USED*/
  section_layout :vtc:linear
  {
    group USS_CODE (ordered, align = 32, run_addr = mem:pfls0)
    {
      select ".text.UssDrivers.*";
      reserved "uss_code_reserved" (size = 32);
    }
    group USS_CONST (ordered, align = 32, run_addr = mem:pfls0)
    {
      select ".rodata.UssDrivers.*";
      reserved "uss_const_reserved" (size = 32);
    } 
    group USS_UnInit_Data (ordered, align = 8, attributes=rw, run_addr = mem:lmuram)
    {
      select ".bss.UssDrivers.*";
      reserved "uss_UnInitdata_reserved" (size = 8, attributes = rw, fill = 0xaa);
    }
    group USS_Data (ordered, align = 8, attributes=rw, run_addr = mem:lmuram)
    {
      select ".data.UssDrivers.*";
      reserved "uss_data_reserved" (size = 8, attributes = rw, fill = 0xaa);
    }
  ...
  group
  {
    ...
    group
    {
      group (ordered, attributes=rw, run_addr=mem:dsram5)
      {
        ...
        select "*InitData.Cpu5.8bit";
        select "*InitData.Cpu5.16bit";
        select "*InitData.Cpu5.32bit";
        select "*InitData.Cpu5.64bit";
        select "*InitData.Cpu5.256bit";
        select "*InitData.Cpu5.Unspecified";
        select "*InitData.Fast.Cpu5.8bit";
        select "*InitData.Fast.Cpu5.16bit";
        select "*InitData.Fast.Cpu5.32bit";
        select "*InitData.Fast.Cpu5.64bit";
        select "*InitData.Fast.Cpu5.256bit";
        select "*InitData.Fast.Cpu5.Unspecified";
        /* Uninitialized Data */
        select ".bss.Ifx_Ssw_Tc5.*";
        select ".bss.Cpu5_Main.*";
        select "(.bss.bss_cpu5|.bss.bss_cpu5.*)";
        select "*ClearedData.Cpu5.8bit";
        select "*ClearedData.Cpu5.16bit";
        select "*ClearedData.Cpu5.32bit";
        select "*ClearedData.Cpu5.64bit";
        select "*ClearedData.Cpu5.256bit";
        select "*ClearedData.Cpu5.Unspecified";
        select "*ClearedData.Fast.Cpu5.8bit";
        select "*ClearedData.Fast.Cpu5.16bit";
        select "*ClearedData.Fast.Cpu5.32bit";
        select "*ClearedData.Fast.Cpu5.64bit";
        select "*ClearedData.Fast.Cpu5.256bit";
        select "*ClearedData.Fast.Cpu5.Unspecified";
      }
      group (ordered, attributes=rw, run_addr=mem:dsram4)
      {
        ...
        select "*InitData.Cpu4.8bit";
        select "*InitData.Cpu4.16bit";
        select "*InitData.Cpu4.32bit";
        select "*InitData.Cpu4.64bit";
        select "*InitData.Cpu4.256bit";
        select "*InitData.Cpu4.Unspecified";
        select "*InitData.Fast.Cpu4.8bit";
        select "*InitData.Fast.Cpu4.16bit";
        select "*InitData.Fast.Cpu4.32bit";
        select "*InitData.Fast.Cpu4.64bit";
        select "*InitData.Fast.Cpu4.256bit";
        select "*InitData.Fast.Cpu4.Unspecified";
        /* Uninitialized Data */
        select ".bss.Ifx_Ssw_Tc4.*";
        select ".bss.Cpu4_Main.*";
        select "(.bss.bss_cpu4|.bss.bss_cpu4.*)";
        select "*ClearedData.Cpu4.8bit";
        select "*ClearedData.Cpu4.16bit";
        select "*ClearedData.Cpu4.32bit";
        select "*ClearedData.Cpu4.64bit";
        select "*ClearedData.Cpu4.256bit";
        select "*ClearedData.Cpu4.Unspecified";
        select "*ClearedData.Fast.Cpu4.8bit";
        select "*ClearedData.Fast.Cpu4.16bit";
        select "*ClearedData.Fast.Cpu4.32bit";
        select "*ClearedData.Fast.Cpu4.64bit";
        select "*ClearedData.Fast.Cpu4.256bit";
        select "*ClearedData.Fast.Cpu4.Unspecified";
      }
      ...
      group
      {
        ...
        {
          select ".data.*.lmudata_cpu4";
          select ".bss.*.lmubss_cpu4";
        }
        group (ordered, attributes=rw, run_addr = mem:cpu5_dlmu)
        {
          select ".data.*.lmudata_cpu5";
          select ".bss.*.lmubss_cpu5";
        }
...
#    endif
    ...
    group
    {
      ...
      group (ordered, align = 4, run_addr=mem:pfls4)
      {
        ...
        /* Const Data */
        select "*Const.Cpu4.8bit";
        select "*Const.Cpu4.16bit";
        select "*Const.Cpu4.32bit";
        select "*Const.Cpu4.64bit";
        select "*Const.Cpu4.Unspecified";
        select "*Const.Cpu4.256bit";
        /* Config Data */
        select "*Config.Cpu4.8bit";
        select "*Config.Cpu4.16bit";
        select "*Config.Cpu4.32bit";
        select "*Config.Cpu4.64bit";
        select "*Config.Cpu4.Unspecified";
        select "*Config.Cpu4.256bit";
        /* Default */
      ...
      group (ordered, align = 4, run_addr=mem:pfls5)
      {
        ...
        /* Const Data */
        select "*Const.Cpu5.8bit";
        select "*Const.Cpu5.16bit";
        select "*Const.Cpu5.32bit";
        select "*Const.Cpu5.64bit";
        select "*Const.Cpu5.Unspecified";
        select "*Const.Cpu5.256bit";
        /* Config Data */
        select "*Config.Cpu5.8bit";
        select "*Config.Cpu5.16bit";
        select "*Config.Cpu5.32bit";
        select "*Config.Cpu5.64bit";
        select "*Config.Cpu5.Unspecified";
        select "*Config.Cpu5.256bit";
        /* Default */
