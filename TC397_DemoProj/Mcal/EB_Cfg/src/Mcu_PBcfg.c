...
/* MISRA2012_RULE_5_5_JUSTIFICATION: External identifiers going beyond 32 chars.
   in generated code due to Autosar Naming constraints.*/
static const Mcu_PllDistributionConfigType Mcu_kPllDistributionConfiguration_Config_1 =
{
  /* CCUCON0 value */
  0x17230113U,
  /* CCUCON1 value */
...
/*
   ...
   Multilplicity : 1 - *
*/
static const Mcu_ClockConfigType Mcu_kClockConfiguration_Config[2] =
{
  ...
  /*McuClockSettingConfig_1*/
  {
    ...
    10U,
    /* PLL clock divider configuration pointer */
    &Mcu_kPllDistributionConfiguration_Config_1,
    /* External Clock configuration */
    0x00000000U,
    /* Backup frequency K Divider value for both PLLs */
    0x0325U,
