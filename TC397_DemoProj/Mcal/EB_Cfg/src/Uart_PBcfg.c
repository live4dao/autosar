...
[/cover] */
/* Transmit notification function of UartChannel_0 */
extern void UartTx(Uart_ErrorIdType ErrorId);
/* Receive notification function of UartChannel_0 */
extern void UartRx(Uart_ErrorIdType ErrorId);
/*
