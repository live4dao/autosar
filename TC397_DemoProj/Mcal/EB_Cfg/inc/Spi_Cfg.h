...
/* Is QSPI5 Used */
#define SPI_HW_QSPI5_USED                     (STD_ON)
/* Index for QSPI5 module */
#define SPI_QSPI5_INDEX                       (5U)
/* Sync/Async */
#define SPI_QSPI5_HWTYPE                      (SPI_SYNC_BUS)
...
#define SPI_JOB_QUEUE_LENGTH_QSPI4            (3U)
/* Job Queue Length for QSPI5 */
#define SPI_JOB_QUEUE_LENGTH_QSPI5            (3U)
/* QSPI Channel Index */
...
#define SPI_CORE0_ENABLE     STD_OFF
...
#define SPI_SEQUENCE_COUNT_CORE0      0U
...
#define SPI_QSPI4_CORE          1
#define SPI_QSPI5_CORE          1
