...
**  VERSION   : 10.0.0                                                         **
**                                                                            **
**  DATE, TIME: 2024-02-04, 18:05:19              !!!IGNORE-LINE!!!           **
**                                                                            **
...
#define SMU_AR_RELEASE_MINOR_VERSION     (4U)
#define SMU_AR_RELEASE_REVISION_VERSION  (0U)
...
#define SMU_INIT_CHECK_API               (STD_OFF)
...
#define SMU_DEV_ERROR_DETECT             (STD_OFF)

/*Safety enable switch*/
#define SMU_SAFETY_ENABLE                (STD_OFF)
...
#define SMU_GROUP4_POS                   (0x1c07ff7U)
#define SMU_GROUP5_POS                   (0x1c07ff7U)
#define SMU_GROUP6_POS                   (0x3bffdffU)
#define SMU_GROUP7_POS                   (0xfffff1ffU)
#define SMU_GROUP8_POS                   (0xfeffffffU)
#define SMU_GROUP9_POS                   (0xf0f3802bU)
#define SMU_GROUP10_POS                  (0x77ffffU)
#define SMU_GROUP11_POS                  (0x3fffU)
#define SMU_GROUP20_POS                  (0xfff0U)
#define SMU_GROUP21_POS                  (0x1ffbfU)

/*Alarm Execution status validity check masks*/
#define SMU_ALARMEXECSTATUS_VALID        (0xbff0bffU)
