...
/* Conditional Inclusion of Production Error */
...
#ifndef STM_AR_RELEASE_MAJOR_VERSION
#error "STM_AR_RELEASE_MAJOR_VERSION is not defined. "
#endif

#ifndef STM_AR_RELEASE_MINOR_VERSION
#error "STM_AR_RELEASE_MINOR_VERSION is not defined. "
#endif

#ifndef STM_AR_RELEASE_REVISION_VERSION
#error "STM_AR_RELEASE_REVISION_VERSION is not defined. "
#endif
...
#if ( STM_SW_MAJOR_VERSION != 20U )
#error "STM_SW_MAJOR_VERSION does not match. "
#endif

#if ( STM_SW_MINOR_VERSION != 25U )
...
#if ( STM_AR_RELEASE_MAJOR_VERSION != MCAL_AR_RELEASE_MAJOR_VERSION )
#error "STM_AR_RELEASE_MAJOR_VERSION does not match. "
#endif

#if ( STM_AR_RELEASE_MINOR_VERSION != MCAL_AR_RELEASE_MINOR_VERSION )
#error "STM_AR_RELEASE_MINOR_VERSION does not match. "
#endif

#if ( STM_AR_RELEASE_REVISION_VERSION != MCAL_AR_RELEASE_REVISION_VERSION )
#error "STM_AR_RELEASE_REVISION_VERSION does not match. "
#endif
...
#if(STM_E_CLC_ENABLE_ERR_DEM_REPORT == STM_ENABLE_DEM_REPORT)
static void Stm_lReportDemError(const Dem_EventIdType EventId,
...
;
    ...
    /*(STM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    {
      #if(STM_E_CLC_ENABLE_ERR_DEM_REPORT == STM_ENABLE_DEM_REPORT)
      /*Report Production Error for STM enable passed*/
      Stm_lReportDemError(STM_E_CLC_ENABLE_ERR, DEM_EVENT_STATUS_PASSED);
      #endif
    ...
    {
      #if(STM_E_CLC_ENABLE_ERR_DEM_REPORT == STM_ENABLE_DEM_REPORT)
      /*Report Production Error for STM CLC enable error*/
      Stm_lReportDemError(STM_E_CLC_ENABLE_ERR, DEM_EVENT_STATUS_FAILED);
      #endif
    }
  }
}
...
** Traceability     :                                                         **
**                                                                            **
** Syntax           : static void Stm_lReportDemError(const Dem_EventIdType   **
...
const Dem_EventStatusType EventStatus)
{
  ...
  /* Report Production Error for AS422 by calling Mcal_Wrapper_Dem_ReportErrorStatus */
  Mcal_Wrapper_Dem_ReportErrorStatus(EventId, EventStatus);
  #endif
  #if (MCAL_AR_VERSION == MCAL_AR_440)
  /*Report Production Error for AS440 by calling Mcal_Wrapper_Dem_SetEventStatus */
  (void)Mcal_Wrapper_Dem_SetEventStatus(EventId, EventStatus);
  #endif
}
#endif
/* End of Stm_lReportDemError */
