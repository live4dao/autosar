...
********************************************************************************
*   Description     : The header file lwipopts.h contains the configurations of
*                     LWIP module.
*                                           
********************************************************************************
...
#ifndef _TCPIP_LWIPOPTS_H_
#define _TCPIP_LWIPOPTS_H_
 ...
 */
#define MEM_SIZE                        TCPIP_TX_BUFFER_SIZE
 ...
 */
#define MEMP_NUM_UDP_PCB                (TCPIP_UDP_SOCKET_MAX + TCPIP_DHCP_CLIENT_MAX)

/**
 * MEMP_NUM_TCP_PCB: the number of simultaneously active TCP connections.
 * (requires the LWIP_TCP option)
 */
#define MEMP_NUM_TCP_PCB                TCPIP_TCP_SOCKET_MAX

/**
 * MEMP_NUM_TCP_PCB_LISTEN: the number of listening TCP connections.
 * (requires the LWIP_TCP option)
 */
#define MEMP_NUM_TCP_PCB_LISTEN         TCPIP_TCP_SOCKET_LISTEN_MAX
 ...
 */
#define MEMP_NUM_REASSDATA              TCPIP_IPREASS_DGRAMS_MAX
 ...
 */
#define MEMP_NUM_IGMP_GROUP             (TCPIP_IGMP_GROUP_MAX + TCPIP_NETIF_CTRL_MAX)
 ...
 */
#define PBUF_POOL_SIZE                  TCPIP_RX_BUFFER_NUM
 ...
 */
#define LWIP_ARP                        TCPIP_ARP_ENABLED

/**
 * ARP_TABLE_SIZE: Number of active MAC-IP address pairs cached.
 */
#define ARP_TABLE_SIZE                  TCPIP_ARP_TABLE_SIZE_MAX

/** the time an ARP entry stays valid after its last update,
 *  for ARP_TMR_INTERVAL = 1000, this is
 *  (60 * 5) seconds = 5 minutes.
 */
#define ARP_MAXAGE                      (TCPIP_ARP_TABLE_ENTRY_TIMEOUT/ARP_TMR_INTERVAL)
 ...
 */
#define LWIP_IPV4                       TCPIP_IPV4_ENABLED
 ...
 * via IP_FRAG.
 */
#define IP_REASSEMBLY                   TCPIP_IPFRAGMENTATION_RX_ENABLED
 ...
 */
#define IP_FRAG                         TCPIP_IPFRAGMENTATION_RX_ENABLED
 ...
 */
#define IP_REASS_MAXAGE                 (TCPIP_IPREASS_TIMEOUT/IP_TMR_INTERVAL)
 ...
 */
#define IP_REASS_MAX_PBUFS              TCPIP_IPFRAGMENTS_MAX
 ...
 */
#define LWIP_ICMP                       TCPIP_ICMP_ENABLED

/**
 * ICMP_TTL: Default value for Time-To-Live used by ICMP packets.
 */
#define ICMP_TTL                        TCPIP_ICMP_TTL
 ...
 */
#define LWIP_DHCP                       TCPIP_DHCP_CLIENT_ENABLED
#ifndef TCPIP_DHCP_CLIENT_MAX
 ...
 */
#define LWIP_AUTOIP                     TCPIP_AUTOIP_ENABLED
 ...
 */
#define LWIP_DHCP_AUTOIP_COOP_TRIES     255
 ...
 */
#define LWIP_IGMP                       TCPIP_IGMP_ENABLED
 ...
 */
#define LWIP_UDP                        TCPIP_UDP_ENABLED
 ...
 */
#define LWIP_TCP                        TCPIP_TCP_ENABLED

#define TCP_MSL                         TCPIP_TCP_MSL
//#define LWIP_DISABLE_TCP_SANITY_CHECKS  1
/**
 * TCP_TTL: Default Time-To-Live value.
 */
#define TCP_TTL                         TCPIP_TCP_TTL
 ...
 */
#define TCP_WND                         TCPIP_TCP_RECEIVE_WINDOW_MAX


/**
 * TCP_MAXRTX: Maximum number of retransmissions of data segments.
 */
#define TCP_MAXRTX                      TCPIP_TCP_RETRANSMISSION_MAX

/**
 * TCP_SYNMAXRTX: Maximum number of retransmissions of SYN segments.
 */
#define TCP_SYNMAXRTX                   TCPIP_TCP_SYN_RETRANSMISSION_MAX
 ...
 */
#define LWIP_TCP_KEEPALIVE              TCPIP_TCP_KEEP_ALIVE_ENABLED

#if (LWIP_TCP_KEEPALIVE == STD_ON)
#define TCP_KEEPIDLE_DEFAULT            TCPIP_TCP_KEEP_ALIVE_TIME
#define TCP_KEEPINTVL_DEFAULT           TCPIP_TCP_KEEP_ALIVE_INTERVAL
#define TCP_KEEPCNT_DEFAULT             TCPIP_TCP_KEEP_ALIVE_PROBES_MAX
#endif
...
*/
#define PBUF_POOL_BUFSIZE               TCPIP_RX_BUFFER_SIZE
 ...
 */
#define LWIP_IPV6                       TCPIP_IPV6_ENABLED
