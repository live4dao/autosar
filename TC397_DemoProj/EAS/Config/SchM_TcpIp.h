...
*   exclusive Area
*******************************************************************************/
#define SchM_Enter_TcpIp_TCPIP_EXCLUSIVE_AREA_0()           SuspendAllInterrupts()
#define SchM_Exit_TcpIp_TCPIP_EXCLUSIVE_AREA_0()            ResumeAllInterrupts()


#define SchM_Enter_TcpIp_TCPIP_EXCLUSIVE_AREA_1()
#define SchM_Exit_TcpIp_TCPIP_EXCLUSIVE_AREA_1()


#define SchM_Enter_TcpIp_TCPIP_EXCLUSIVE_AREA_2()
#define SchM_Exit_TcpIp_TCPIP_EXCLUSIVE_AREA_2()
