...
#define SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_3()
#define SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_3()


#define SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_4()
#define SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_4()
