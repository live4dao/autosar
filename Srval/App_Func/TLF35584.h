...
typedef enum
{
    ...
    IFRegAddr = 0x1C,        /* Interrupt flags */
    ...
    AbistSelect0RegAddr =0x2E,
    AbistSelect1RegAddr =0x2F,
    AbistCtrl0RegAddr =0x2C
} tlf35584RegAddr;
...
{
    No_Interrupt = 0,
    Interrupt_Flag_Active = 1
} interruptType;

/* Interrupt not serviced in time flag */
typedef enum
{
    No_IF_Timeout_Happened = 0,
    Interrupt_Timeout_Happened = 1
} intmissType;

/* Monitor event of short to ground status */
typedef enum
{
    ShortToGround_undetected = 0,
    ShortToGround_detected = 1
} MonSg0EventType;

/* Monitor event of over voltage status */
typedef enum
{
    OverVoltage_undetected = 0,
    OverVoltage_detected = 1
} MonSg1EventType;

/* Monitor event of under voltage status  */
typedef enum
{
    UnderVoltage_undetected = 0,
    UnderVoltage_detected = 1
} MonSg2EventType;
...
{
    Comparator_only = 0,
    Comparator_and_corresponding = 1
} FullPathTestType;
typedef enum
{
    Predefined_sequence = 0,
    Single_comparator_test = 1
} ABISTSequenceType;
typedef enum
{
    Safe_state_related = 0,
    Interrupt_related = 1
} SafetyPathType;
typedef enum
{
...
/* System Interrupt flags bitfields*/
typedef struct
{
    interruptType SYS : 1;   /* System interrupt flag */
    interruptType WK : 1;    /* Wake interrupt flag double bit error flag                             */
    interruptType SPI : 1;   /* SPI interrupt flag                                      */
    interruptType MON : 1;   /* Monitor interrupt flag                                  */
    interruptType OTW : 1;   /* Over temperature warning interrupt flag                                               */
    interruptType OTF : 1;   /* Over temperature failure interrupt flag                                      */
    interruptType ABIST : 1; /* Requested ABIST operation performed flag                                     */
    intmissType INTMISS : 1; /* Interrupt not serviced in time flag                                                               */
} tlf35584IFBits;
...
/* Monitor status flags 0 bitfields */
typedef struct
{
    MonSg0EventType PREGSG : 1;
    MonSg0EventType UCSG : 1;
    MonSg0EventType STBYSG : 1;
    MonSg0EventType VCORESG : 1;
    MonSg0EventType COMSG : 1;
    MonSg0EventType VREFSG : 1;
    MonSg0EventType TRK1SG : 1;
    MonSg0EventType TRK2SG : 1;

} tlf35584Monsf0Bits;

/* Monitor status flags 1 bitfields */
typedef struct
{
    MonSg1EventType PREGOV : 1;
    MonSg1EventType UCOV : 1;
    MonSg1EventType STBYOV : 1;
    MonSg1EventType VCOREOV : 1;
    MonSg1EventType COMOV : 1;
    MonSg1EventType VREFOV : 1;
    MonSg1EventType TRK1OV : 1;
    MonSg1EventType TRK2OV : 1;

} tlf35584Monsf1Bits;
/* Monitor status flags 2 bitfields */
typedef struct TLF35584
{
    MonSg2EventType PREGUV : 1;
    MonSg2EventType UCUV : 1;
    MonSg2EventType STBYUV : 1;
    MonSg2EventType VCOREUV : 1;
    MonSg2EventType COMUV : 1;
    MonSg2EventType VREFUV : 1;
    MonSg2EventType TRK1UV : 1;
    MonSg2EventType TRK2UV : 1;
...
typedef struct
{
    ABISTSelectType PREGOV : 1;
    ABISTSelectType UCOV : 1;
    ABISTSelectType STBYOV : 1;
    ABISTSelectType VCOREOV : 1;
    ABISTSelectType COMOV : 1;
    ABISTSelectType VREFOV : 1;
    ABISTSelectType TRK1OV : 1;
    ABISTSelectType TRK2OV : 1;
} tlf35584AbistSelect0Bits;

typedef struct
{
    ABISTSelectType PREGUV : 1;
    ABISTSelectType UCUV : 1;
    ABISTSelectType STBYUV : 1;
    ABISTSelectType VCOREUV : 1;
    ABISTSelectType COMUV : 1;
    ABISTSelectType VREFUV : 1;
    ABISTSelectType TRK1UV : 1;
    ABISTSelectType TRK2UV : 1;
} tlf35584AbistSelect1Bits;

typedef struct
{
    ABISTOperationType START : 1;
    FullPathTestType PATH : 1;
    ABISTSequenceType SINGLE : 1;
    SafetyPathType INT : 1;
    ABISTGlobalErrorType STATUS : 4;

} tlf35584AbistCtrl0Bits;
...
typedef union
{
    uint8 U;          /* Unsigned access  */
    sint8 I;          /* Signed access    */
    tlf35584IFBits B; /* Bitfield access  */
} tlf35584IF;
...
typedef union
{
    uint8 U;                    /* Unsigned access  */
    sint8 I;                    /* Signed access    */
    tlf35584AbistSelect0Bits B; /* Bitfield access  */
} tlf35584AbistSelect0;
typedef union
{
    uint8 U;                    /* Unsigned access  */
    sint8 I;                    /* Signed access    */
    tlf35584AbistSelect1Bits B; /* Bitfield access  */
} tlf35584AbistSelect1;

typedef union
{
    uint8 U;                  /* Unsigned access  */
    sint8 I;                  /* Signed access    */
    tlf35584AbistCtrl0Bits B; /* Bitfield access  */
} tlf35584AbistCtrl0;
...
typedef volatile struct
{
    ...
    tlf35584IF IF;              /* 0x1C, Interrupt flags                            */
    ...
    tlf35584AbistSelect0 ABISTSELECT0; /* 0x2E, ABIST_SELECT 0 */
    tlf35584AbistSelect1 ABISTSELECT1; /* 0x2F, ABIST_SELECT 1 */
    tlf35584AbistCtrl0 ABISTCTRL0;     /* 0x2C, ABIST control 0*/
} tlf35584;
