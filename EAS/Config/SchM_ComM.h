...
#define SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_2()
#define SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_2()


#define SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_3()
#define SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_3()


#define SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_4()
#define SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_4()


#define SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_5()
#define SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_5()


#define SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_6()
#define SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_6()


#define SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_7()
#define SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_7()
