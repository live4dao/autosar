...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: With I2c_GetVersionInfo disabled
I2c_GetVersionInfo is implemented as Function like macro*/
#define I2c_GetVersionInfo(VersionInfoPtr) (ERROR_I2c_GetVersionInfo_API_IS_NOT_SELECTED)
