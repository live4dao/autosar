...
**  VERSION   : 6.0.0                                                         **
**                                                                            **
**  DATE, TIME: 2024-01-25, 14:02:11                 !!!IGNORE-LINE!!!     **
**                                                                            **
...
#define STM_AR_RELEASE_MINOR_VERSION     (4U)
#define STM_AR_RELEASE_REVISION_VERSION  (0U)

#define STM_SW_MAJOR_VERSION  (20U)
#define STM_SW_MINOR_VERSION  (25U)
...
#define STM_CORE2_MAX_TIMERS       (0x1U)
#define STM_CORE3_MAX_TIMERS       (0x1U)
#define STM_CORE4_MAX_TIMERS       (0x1U)
#define STM_CORE5_MAX_TIMERS       (0x1U)
...
*/
#define STM_DEV_ERROR_DETECT                (  STD_OFF)
...
/* production error enable/disable for STM module clock enable failure */
