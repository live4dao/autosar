...
#define WDG_17_SCU_AR_RELEASE_MINOR_VERSION     (4U)
#define WDG_17_SCU_AR_RELEASE_REVISION_VERSION  (0U)
...
#define WDG_17_SCU_CONFIGURED_CORE2                                 (STD_ON)

#define WDG_17_SCU_CONFIGURED_CORE3                                 (STD_ON)

#define WDG_17_SCU_CONFIGURED_CORE4                                 (STD_ON)

#define WDG_17_SCU_CONFIGURED_CORE5                                 (STD_ON)

/* WDG_MAX_TIMERS: holds maximum number of WDG timers configured */

#define WDG_17_SCU_MAX_TIMERS (6U) 
