...
**  VERSION   : 26.0.0                                                        **
**                                                                            **
**  DATE, TIME: 2024-03-11, 13:38:23             !!!IGNORE-LINE!!!            **
**                                                                            **
...
*******************************************************************************/
/******************************************************************************/
extern void IcuTimestampNotification_USS_RX1 (void);
extern void IcuTimestampNotification_USS_RX10 (void);
extern void IcuTimestampNotification_USS_RX11 (void);
extern void IcuTimestampNotification_USS_RX12 (void);
extern void IcuTimestampNotification_USS_RX2 (void);
extern void IcuTimestampNotification_USS_RX3 (void);
extern void IcuTimestampNotification_USS_RX4 (void);
extern void IcuTimestampNotification_USS_RX5 (void);
extern void IcuTimestampNotification_USS_RX6 (void);
extern void IcuTimestampNotification_USS_RX7 (void);
extern void IcuTimestampNotification_USS_RX8 (void);
extern void IcuTimestampNotification_USS_RX9 (void);
/******************************************************************************/
/*******************************************************************************
...
static const Icu_17_TimerIp_ChannelConfigType Icu_17_TimerIp_kChannelConfigCore_0[ ] =
{
  {
    /* ICU Channel 0 */
    &IcuTimestampNotification_USS_RX1,/*Notification-function name*/
    ...
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
      (uint8)ICU_17_TIMERIP_BOTH_EDGES,/*Default Start Edge */
      (uint8)ICU_17_TIMERIP_LINEAR_BUFFER,/*Measurement Property*/
      ...
      100U,/* Filtering time for rising edge */
      100U,/* Filtering time for falling edge */
      ...
      /* CTRL data */
      ((ICU_TIMEBASE_TBU_TS0 << IFX_GTM_TIM_CH_CTRL_GPR0_SEL_OFF)|(ICU_GTM_TIM_MODE_TIEM << IFX_GTM_TIM_CH_CTRL_TIM_MODE_OFF)|
      (ICU_ISL_DSL_IGNORE_DSL<<IFX_GTM_TIM_CH_CTRL_DSL_OFF)|
      ...
      (1UL<<IFX_GTM_TIM_CH_CTRL_FLT_EN_OFF)),
      /* ECTRL data */
      (0UL|
      0UL|
      0UL),
  ...
  {
    /* ICU Channel 1 */
    &IcuTimestampNotification_USS_RX2,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 2 */
    &IcuTimestampNotification_USS_RX3,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 3 */
    &IcuTimestampNotification_USS_RX4,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 4 */
    &IcuTimestampNotification_USS_RX5,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 5 */
    &IcuTimestampNotification_USS_RX6,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 6 */
    &IcuTimestampNotification_USS_RX7,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 7 */
    &IcuTimestampNotification_USS_RX8,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 8 */
    &IcuTimestampNotification_USS_RX9,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 9 */
    &IcuTimestampNotification_USS_RX10,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 10 */
    &IcuTimestampNotification_USS_RX11,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
  ...
  {
    /* ICU Channel 11 */
    &IcuTimestampNotification_USS_RX12,/*Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*Timeout Notification-function name*/
    (Icu_17_TimerIp_NotifiPtrType)0,/*GPT12 Counter overflow Notification-function name*/
    {
      (uint8)ICU_17_TIMERIP_MODE_TIMESTAMP,/*Measurement Mode*/
...
const Icu_17_TimerIp_ConfigType Icu_17_TimerIp_Config =
{
  ...
  #if (ICU_17_TIMERIP_SINGLE_CORE == STD_OFF)
  {
    ...
    (uint16)(ICU_CORE0 | (uint8)9),
    (uint16)(ICU_CORE0 | (uint8)10),
    (uint16)(ICU_CORE0 | (uint8)11)
  },
  #endif
};
